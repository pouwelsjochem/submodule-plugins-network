...
-- RDD - I needed a way to determine at the very end whether to overall test run succeeded (all
--       tests passed, right number of tests run), so I exposed is_passing from the Builder.
--
--       Alternatively, we could just provide access to the Test.Builder in order to get access
--       to its "is_passing".
--
function m.is_passing ()
